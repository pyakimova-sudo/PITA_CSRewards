...
data class Drink_Menu(
    ...
    companion object {
        ...
        val defaultDrinks = listOf(
            Drink_Menu(name = " Brown", Drink_Type = "Coffee", ingredients = listOf("Coffee", "Milk", "Ice")),
            Drink_Menu(name = "Strawberry Smoothie", Drink_Type ="Smoothie", ingredients = listOf("Strawberry", "Milk", "Banana")),
