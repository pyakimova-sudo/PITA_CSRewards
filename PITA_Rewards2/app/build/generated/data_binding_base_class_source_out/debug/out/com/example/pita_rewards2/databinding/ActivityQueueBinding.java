...
public final class ActivityQueueBinding implements ViewBinding {
  ...
  private ActivityQueueBinding(@NonNull ConstraintLayout rootView, @NonNull ConstraintLayout main) {
  ...
  public static ActivityQueueBinding bind(@NonNull View rootView) {
    ...
    return new ActivityQueueBinding((ConstraintLayout) rootView, main);
  }
}
